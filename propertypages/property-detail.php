       ...
       <div id="thumbcarousel" class="carousel slide" data-interval="false">
        <div id="carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                if(count($listing_images)>=1) {
					for($r =1; $r<count($listing_images); $r++) {
						echo '<div class="item" data-toggle="modal" data-target="#preview'. $listing_images[$r]['id'] .'"><img src="'.
                            $siteurl.'/images/prop/'.$listing_images[$r]['image'].'" class="imge"></div>';

					    ?>

					    <!-- Modal -->
                        <div class="modal scale" id="preview<? echo $listing_images[$r]['id']; ?>" role="dialog">
                            <div class="modal-dialog modal-img">
                            <!-- Modal content-->
                            <div class="modal-content">
                              <img src="<? echo $siteurl; ?>/images/prop/<? echo $listing_images[$r]['image']; ?>" class="imge">
                            </div>
    ...
    <div class="clearfix">
        <div id="thumbcarousel" class="carousel slide" data-interval="false">
            <div class="carousel-inner">
				...
				//$row_count = count($listing_images);mysqli_num_rows($res);
					/*if($row_count>=1) {
						$i=0;
						while($row=mysqli_fetch_assoc($res)) {*/
					for($i=0; $i<count($listing_images); $i++){
				?>
					<div data-target="#carousel" data-slide-to="<? echo $i; ?>" class="thumb">
                        <img src="/images/prop/230_144/<? echo $listing_images[$i]['image']; ?>"></div>
				<?
				/*$i++;
				}*/
				}
       ...
       <div class="row mt10">
             <div class="col-md-12 col-sm-12 col-xs-12 property-news-head mt20">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 brdr">
                  <form name="advsrch" action="<? echo $siteurl; ?>/property-list" class="form-horizontal" method="get">
...
from listings l where l.post_sts=1 and l.category='".$prop['category']."' and randuniq!='$pid' order by id desc limit 4");
			*/
			...
			if(count($linked_property)>=1) {
				foreach($linked_property as $key => $rp) {
