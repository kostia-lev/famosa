  ...
  <div class="row col-md-12">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 pdb20">
        ...
        if(!@$_SESSION['usr']) {
            ...
            $row=$GLOBALS['db']->singlerec("select * from register where email='".$_SESSION['usr']."'");
            $img=$row['prof_image'];
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 pdb20">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 pdb20">
          ...
          <div class=" center-block mt10 pdb25">
              <a href="#"><i id="social-fb" class="social fb"></i><img src="/assets/images/social icon 1.png"></a>
              <a href="#"><i id="social-tw" class="social tw"></i><img src="/assets/images/social icon 2.png"></a>
              <a href="#"><i id="social-gp" class="social gg"></i><img src="/assets/images/social icon 3.png"></a>
              <a href="#"><i id="social-em" class="social skype"></i><img src="/assets/images/social icon 4.png"></a>
          </div>
...
<div class="container">
  <div class="row col-md-12">
      ...
      Copyright &copy; 2017 <?php echo strtoupper($GLOBALS['generalset']['website_title']); ?> | All rights reserved.
      </div><!--col-md-6-->
