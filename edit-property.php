...
else if($usr!=$prop['email'] && $row['role']=="broker" || $row['role']=="office-manager") {
    echo "<script>location.href='$siteurl/manage-your-list';</script>";
	header("Location: $siteurl/manage-your-list");  exit;
}
?>
    ...
    <div class="container">
        ...
        <div class="col-md-9 col-sm-12 col-xs-12 mt20">
            <div class="col-md-12 col-sm-12 col-xs-12 profile-brdr-2">
                <div class="pdt10">
                    <div class="row col-md-10 col-sm-6 col-xs-12 property-dash-head" sty>Modifica immobile<br></div>
                </div>
                <div class="mt40">
                ...
                if(isset($p_ad)) {
                    ...
                    if ($_FILES['file']['tmp_name'] != "" && $_FILES['file']['tmp_name'] != "null") {
                        ...
                        if (empty($title) || empty($types) || empty($cat) || empty($pfor) || empty($loc) || empty($eprice) || empty($carea) || empty($poss) || empty($hall) || empty($furnish) || empty($energy) || empty($descrip)) {
                            $error = "";
                            if (empty($title)) {
                                $error .= "Titolo immobile, ";
                            }
                            if (empty($types)) {
                                $error .= "Tipo immobile, ";
                            }
                            if (empty($cat)) {
                                $error .= "Categoria immobile, ";
                            }
                            if (empty($pfor)) {
                                $error .= "Immobile in, ";
                            }
                            if (empty($loc)) {
                                $error .= "Città immobile, ";
                            }
                            if (empty($eprice)) {
                                $error .= "Prezzo immobile, ";
                            }
                            if (empty($carea)) {
                                $error .= "Superficie immobile, ";
                            }
                            if (empty($poss)) {
                                $error .= "Stato attuale immobile, ";
                            }
                            if (empty($hall)) {
                                $error .= "Totale locali, ";
                            }
                            if (empty($furnish)) {
                                $error .= "Stato arredamento, ";
                            }
                            if (empty($energy)) {
                                $error .= "Classe energetica, ";
                            }
                            if (empty($descrip)) {
                                $error .= "Descrizione immobile.";
                            }
                            ...
                            foreach ($files as $file) {
                                ...
                                $newname = 'prop' . $prop['id'] . '_' . $oname . '.' . $ext;
                ...
                ?>
                 <form class="tab-content contain" id="p_ad" action="<? echo $siteurl; ?>/edit-property/<? echo $prop_id; ?>/<? echo $prop['slug']; ?>" method="post" enctype="multipart/form-data">
                 ...
                 <div class="tab-pane active" id="details">
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                 <label class="col-md-12  col-sm-12 col-xs-12">
                                     <input type="text" name="title" class="post-add-form-control" placeholder="Inserisci titolo immobile" value="<? echo $prop['prop_title']; ?>">
                                 </label>
                             </label>
                             ...
                             <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                 <label class="col-md-12 col-sm-12 col-xs-12">
                                     <select name="types" class="form-control post-add-selectbox">
                                         ...
                                         <option value="residenziale" <? if($prop['types']=='residenziale') echo "selected"; ?>>Residenziale</option>
                                         <option value="commerciale" <? if($prop['types']=='commerciale') echo "selected"; ?>>Commerciale</option>
                                         <option value="immobili-di-lusso" <? if($prop['types']=='immobili-di-lusso') echo "selected"; ?>>Immobili di lusso</option>
                                         <option value="nuove-costruzioni" <? if($prop['types']=='nuove-costruzioni') echo "selected"; ?>>Nuove costruzioni</option>
                                     </select>
                                 </label>
                             </label>
                             ...
                             <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                 <label class="col-md-12 col-sm-12 col-xs-12">
                                     <select name="cat" class="form-control post-add-selectbox">
                                         ...
                                         <option value="appartamento" <? if($prop['category']=='appartamento') echo "selected"; ?>>Appartamento</option>
                                         <option value="attico-mansarda" <? if($prop['category']=='attico-mansarda') echo "selected"; ?>>Attico / Mansarda</option>
                                         <option value="box-garage" <? if($prop['category']=='box-garage') echo "selected"; ?>>Box / Garage</option>
                                         <option value="casa-indipendente" <? if($prop['category']=='casa-indipendente') echo "selected"; ?>>Casa indipendente</option>
                                         <option value="loft-open-space" <? if($prop['category']=='loft-open-space') echo "selected"; ?>>Loft / Open Space</option>
                                         <option value="palazzo-stabile" <? if($prop['category']=='palazzo-stabile') echo "selected"; ?>>Palazzo / Stabile</option>
                                         <option value="rustico-casale" <? if($prop['category']=='rustico-casale') echo "selected"; ?>>Rustico / Casale</option>
                                         <option value="villa" <? if($prop['category']=='villa') echo "selected"; ?>>Villa</option>
                                         <option value="villetta-a-schiera" <? if($prop['category']=='villetta-a-schiera') echo "selected"; ?>>Villetta a schiera</option>
                                         <option value="altro" <? if($prop['category']=='altro') echo "selected"; ?>>Altro</option>
                                     </select>
                                 </label>
                             </label>
                             ...
                             <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                 <label class="col-md-12 col-sm-12 col-xs-12">
                                     <select name="pfor" class="form-control post-add-selectbox">
                                         ...
                                         <option value="vendita" <? if(isset($prop['prop_for'])=='vendita') echo "selected"; ?>>Vendita</option>
                                         <option value="affitto" <? if(isset($prop['prop_for'])=='affitto') echo "selected"; ?>>Affitto</option>
                                     </select>
                                 </label>
                             </label>
                             ...
                             <label class="col-md-8  col-sm-6 col-xs-12">
                                 <label class="col-md-12 col-sm-12 col-xs-12 mt20">
                                     <input id="autocomplete" onFocus="geolocate()" type="text" name="loc" value="<? echo $prop['location']; ?>" class="post-add-form-control" placeholder="Inserisci citt&aacute; immobile" autocomplete="off">
                                 </label>
                             </label>
                             ...
                             <label class="col-md-8  col-sm-6 col-xs-12">
                                 <label class="col-md-12 col-sm-12 col-xs-12 mt20">
                                     <input id="addr" onFocus="geolocate()" type="text" name="addr" value="<? echo $prop['address']; ?>" class="post-add-form-control" placeholder="Inserisci indirizzo immobile" autocomplete="off">
                                 </label>
                             </label>
                             ...
                             <label class="col-md-8  col-sm-6 col-xs-12">
                                 <label class="col-md-12 col-sm-12 col-xs-12 mt20">
                                     <input type="number" name="cap" value="<? echo $prop['cap']; ?>" class="post-add-form-control" placeholder="Inserisci CAP zona"></label>
                             </label>
                    ...
                    || (event.keyCode==46) )" name="eprice" class=" post-add-form-control" placeholder="Inserisci prezzo in &euro;" value="<? echo $prop['exp_price']; ?>"></label>
                             </label>
                    ...
                    || (event.keyCode==8) || (event.keyCode==9) 
                    || (event.keyCode>34 && event.keyCode<40) 
                    || (event.keyCode==46) )" name="carea" class=" post-add-form-control" placeholder="Metri quadrati" value="<? echo $prop['covered_area']; ?>"></label>
                             </label>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-8 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20">
                                     <select name="poss" class="form-control post-add-selectbox">
                                         ...
                                         <option value="1" <? if($prop['poss_sts']==1) echo "selected"; ?>>Libero</option>
                                         <option value="2" <? if($prop['poss_sts']==2) echo "selected"; ?>>Da costruire</option>
                                         <option value="3" <? if($prop['poss_sts']==3) echo "selected"; ?>>Occupato da proprietario</option>
                                         <option value="4" <? if($prop['poss_sts']==4) echo "selected"; ?>>Occupato da inquilino</option>
                                         <option value="5" <? if($prop['poss_sts']==5) echo "selected"; ?>>Parzialmente Rifinito</option>
                                         <option value="6" <? if($prop['poss_sts']==6) echo "selected"; ?>>Rifiniture Standard</option>
                                         <option value="7" <? if($prop['poss_sts']==7) echo "selected"; ?>>Rifiniture di Lusso</option>
                                         <option value="8" <? if($prop['poss_sts']==8) echo "selected"; ?>>Pre Costruzione</option>
                                         <option value="9" <? if($prop['poss_sts']==9) echo "selected"; ?>>Con Permessi</option>
                                         <option value="10" <? if($prop['poss_sts']==10) echo "selected"; ?>>Convertito</option>
                                         <option value="11" <? if($prop['poss_sts']==11) echo "selected"; ?>>Convertito Parzialmente</option>
                                         <option value="12" <? if($prop['poss_sts']==12) echo "selected"; ?>>Non Convertito</option>
                                     </select>
                                 </label>

                             </label><!--col-md-8-->

                             <label class="col-md-4 col-sm-6 col-xs-12 post-add-box-form-font mt20">Metti in evidenza</label>
                             <label class="col-md-8 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="featured" class="" <? if($prop['featured']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-8 col-sm-6 col-xs-12">
                                 <label class="col-md-6  col-sm-12 col-xs-12 mt20">
                                     ...
                                     <input type="number" name="bed" value="<? echo $prop['bedroom']; ?>" placeholder="Inserisci numero" class="post-add-form-control">
                                 </label>
                                 <label class="col-md-6  col-sm-12 col-xs-12 mt20">
                                     <span class=" post-add-box-font">Bagni</span>
                                     <input type="number" name="bath" value="<? echo $prop['bathroom']; ?>" placeholder="Inserisci numero" class="post-add-form-control">
                                 </label>
                             </label><!--col-md-12-->
                             ...
                             <label class="col-md-8 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20">
                                     <input type="number" name="hall" value="<? echo $prop['hall']; ?>" placeholder="Inserisci totale locali" class="post-add-form-control">
                                 </label>
                             </label><!--col-md-12-->
                             ...
                             <label class="col-md-8 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20">
                                     <select name="furnish" class="form-control post-add-selectbox " >
                                         ...
                                         <option value="1" <? if($prop['furnished']==1) echo "selected"; ?>>Arredato</option>
                                         <option value="2" <? if($prop['furnished']==2) echo "selected"; ?>>Parzialmente arredato</option>
                                         <option value="3" <? if($prop['furnished']==3) echo "selected"; ?>>Non arredato</option>
                                     </select>
                             ...
                             <label class="col-md-8 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20">
                                     <select name="energy" class="form-control post-add-selectbox " >
                                         ...
                                         <option value="1" <? if($prop['energy']==1) echo "selected"; ?>>A+</option>
                                         <option value="2" <? if($prop['energy']==2) echo "selected"; ?>>A</option>
                                         <option value="3" <? if($prop['energy']==3) echo "selected"; ?>>B</option>
                                         <option value="4" <? if($prop['energy']==4) echo "selected"; ?>>C</option>
                                         <option value="5" <? if($prop['energy']==5) echo "selected"; ?>>D</option>
                                         <option value="6" <? if($prop['energy']==6) echo "selected"; ?>>E</option>
                                         <option value="7" <? if($prop['energy']==7) echo "selected"; ?>>F</option>
                                         <option value="8" <? if($prop['energy']==8) echo "selected"; ?>>G</option>
                                         <option value="9" <? if($prop['energy']==9) echo "selected"; ?>>NC</option>
                                     </select>

                                 </label>
                             </label><!--col-md-12-->

                             <label class="col-md-4 col-sm-6 col-xs-12 post-add-box-form-font mt20">Piano (0 terra)</label>
                             <label class="col-md-8 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20">
                                     <input type="number" name="floor" value="<? echo $prop['floors']; ?>" placeholder="Inserisci piano" class="post-add-form-control">
                                 </label>
                             </label><!--col-md-12-->
                             ...
                             <label class="col-md-8 col-sm-6 col-xs-12">
                                 <label class="col-md-12 col-sm-12 col-xs-12">
                                     <textarea style="resize:vertical;height:180px;" class="post-add-form-control mt10" placeholder="Inserisci descrizione immobile" name="descrip" rows="5" cols="5" ><? echo $prop['description']; ?></textarea>
                                 </label>
                             </label>
                             <label class="col-md-4 col-sm-6 col-xs-12 post-add-box-form-font">&nbsp;</label>
                     ...
                     <div class="col-md-9 col-sm-12 col-xs-12 mt5 row">
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="leveled_apartment" class="" <? if($prop['leveled_apartment']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="bungalow" class="" <? if($prop['bungalow']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="old_building" class="" <? if($prop['old_building']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="farmhouse_four_sides" class="" <? if($prop['farmhouse_four_sides']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="farmhouse_three_sides" class="" <? if($prop['farmhouse_three_sides']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="farmhouse_one_side" class="" <? if($prop['farmhouse_one_side']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="villa_vintage" class="" <? if($prop['villa_vintage']==1) echo "checked"; ?>>
                                     </label>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="accessible_people" class="" <? if($prop['accessible_people']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="electric_gate" class="" <? if($prop['electric_gate']==1) echo "checked"; ?>>
                                     </label>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="to_be_restructured" class="" <? if($prop['to_be_restructured']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="alarm_system" class="" <? if($prop['alarm_system']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_public_transportation" class="" <? if($prop['near_public_transportation']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="position" class="" <? if($prop['position']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="restructured" class="" <? if($prop['restructured']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="high_traffic" class="" <? if($prop['high_traffic']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_highway" class="" <? if($prop['near_highway']==1) echo "checked"; ?>>
                                     </label>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="rooftop_terrace" class="" <? if($prop['rooftop_terrace']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="balcony" class="" <? if($prop['balcony']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="basement_garage" class="" <? if($prop['basement_garage']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="concrete" class="" <? if($prop['concrete']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="garage_box" class="" <? if($prop['garage_box']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="garden" class="" <? if($prop['garden']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="pond" class="" <? if($prop['pond']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="exposed_brick" class="" <? if($prop['exposed_brick']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="mosaic" class="" <? if($prop['mosaic']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="noted_palace" class="" <? if($prop['noted_palace']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="panels" class="" <? if($prop['panels']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="parking" class="" <? if($prop['parking']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="glass_wall" class="" <? if($prop['glass_wall']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="stone" class="" <? if($prop['stone']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="pool" class="" <? if($prop['pool']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="parking_space" class="" <? if($prop['parking_space']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="cesspool" class="" <? if($prop['cesspool']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="prefabricated" class="" <? if($prop['prefabricated']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="closet" class="" <? if($prop['closet']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="independent_closet" class="" <? if($prop['independent_closet']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="wood_coating" class="" <? if($prop['wood_coating']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="structure_under_construction" class="" <? if($prop['structure_under_construction']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="putty" class="" <? if($prop['putty']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="patio_deck" class="" <? if($prop['patio_deck']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="flat_roof" class="" <? if($prop['flat_roof']==1) echo "checked"; ?>>
                                     </label>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="unfinished" class="" <? if($prop['unfinished']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="lift_elevator" class="" <? if($prop['lift_elevator']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="redeveloped" class="" <? if($prop['redeveloped']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="outdoor_pool" class="" <? if($prop['outdoor_pool']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="indoor_pool" class="" <? if($prop['indoor_pool']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="reception" class="" <? if($prop['reception']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="first_owner" class="" <? if($prop['first_owner']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="needs_redevelopment" class="" <? if($prop['needs_redevelopment']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="security_service" class="" <? if($prop['security_service']==1) echo "checked"; ?>>
                                     </label>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="frescoes" class="" <? if($prop['frescoes']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="large_hall" class="" <? if($prop['large_hall']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="large_closet" class="" <? if($prop['large_closet']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="kitchenette" class="" <? if($prop['kitchenette']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="conditioned_air" class="" <? if($prop['conditioned_air']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="central_air_conditioned" class="" <? if($prop['central_air_conditioned']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="independent_room" class="" <? if($prop['independent_room']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="fireplace" class="" <? if($prop['fireplace']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="livable_kitchen" class="" <? if($prop['livable_kitchen']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="livable_kitchen_den" class="" <? if($prop['livable_kitchen_den']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="tiled_kitchen" class="" <? if($prop['tiled_kitchen']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="kitchen_kitchenette" class="" <? if($prop['kitchen_kitchenette']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="circular_windows" class="" <? if($prop['circular_windows']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="internal_plasterboard" class="" <? if($prop['internal_plasterboard']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="washing_facilities" class="" <? if($prop['washing_facilities']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="laundry_room" class="" <? if($prop['laundry_room']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="tiled_floors" class="" <? if($prop['tiled_floors']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="parquet_floor" class="" <? if($prop['parquet_floor']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="underfloor_heating" class="" <? if($prop['underfloor_heating']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="gas_stove" class="" <? if($prop['gas_stove']==1) echo "checked"; ?>>
                                     </label>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="accessible_by_boat" class="" <? if($prop['accessible_by_boat']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="town_center" class="" <? if($prop['town_center']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="business_center" class="" <? if($prop['business_center']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="old_town" class="" <? if($prop['old_town']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="surrounded_by_beaches" class="" <? if($prop['surrounded_by_beaches']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="easily_accessible_by_car" class="" <? if($prop['easily_accessible_by_car']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="lagoon_front" class="" <? if($prop['lagoon_front']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="country_side" class="" <? if($prop['country_side']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="settlement" class="" <? if($prop['settlement']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="isolated" class="" <? if($prop['isolated']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="isolated_far_from_settlements" class="" <? if($prop['isolated_far_from_settlements']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="forest_edge" class="" <? if($prop['forest_edge']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="isolated_location" class="" <? if($prop['isolated_location']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_golf_course" class="" <? if($prop['near_golf_course']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="outskirts" class="" <? if($prop['outskirts']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="private_location" class="" <? if($prop['private_location']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="quiet_street" class="" <? if($prop['quiet_street']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="on_the_sea" class="" <? if($prop['on_the_sea']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="on_the_beach" class="" <? if($prop['on_the_beach']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="airport_nearby" class="" <? if($prop['airport_nearby']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="forest_nearby" class="" <? if($prop['forest_nearby']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="channel_nearby" class="" <? if($prop['channel_nearby']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_congress_center" class="" <? if($prop['near_congress_center']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_church" class="" <? if($prop['near_church']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_bus" class="" <? if($prop['near_bus']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="school_bus_stop_nearby" class="" <? if($prop['school_bus_stop_nearby']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_lake" class="" <? if($prop['near_lake']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_sea" class="" <? if($prop['near_sea']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_subway" class="" <? if($prop['near_subway']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_mountain" class="" <? if($prop['near_mountain']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="shops_nearby" class="" <? if($prop['shops_nearby']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_hospital" class="" <? if($prop['near_hospital']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_gym" class="" <? if($prop['near_gym']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_park" class="" <? if($prop['near_park']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="walking_nearby" class="" <? if($prop['walking_nearby']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_wood" class="" <? if($prop['near_wood']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_school" class="" <? if($prop['near_school']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_beach" class="" <? if($prop['near_beach']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_train_station" class="" <? if($prop['near_train_station']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="near_tangential" class="" <? if($prop['near_tangential']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="canal_view" class="" <? if($prop['canal_view']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="lake_view" class="" <? if($prop['lake_view']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="sea_view" class="" <? if($prop['sea_view']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="mountain_view" class="" <? if($prop['mountain_view']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="city_view" class="" <? if($prop['city_view']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="nature_view" class="" <? if($prop['nature_view']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="beach_view" class="" <? if($prop['beach_view']==1) echo "checked"; ?>>
                                     </label>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="nord" class="" <? if($prop['nord']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="nord_est" class="" <? if($prop['nord_est']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="est" class="" <? if($prop['est']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="sud_est" class="" <? if($prop['sud_est']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="sud" class="" <? if($prop['sud']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="sud_ovest" class="" <? if($prop['sud_ovest']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="ovest" class="" <? if($prop['ovest']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="nord_ovest" class="" <? if($prop['nord_ovest']==1) echo "checked"; ?>>
                                     </label>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="ancient" class="" <? if($prop['ancient']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="art_deco" class="" <? if($prop['art_deco']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="art_nouveau" class="" <? if($prop['art_nouveau']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="barocco" class="" <? if($prop['barocco']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="biedermeier" class="" <? if($prop['biedermeier']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="british" class="" <? if($prop['british']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="attic_rooms" class="" <? if($prop['attic_rooms']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="century_home" class="" <? if($prop['century_home']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="colonnade" class="" <? if($prop['colonnade']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="contemporary" class="" <? if($prop['contemporary']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="edwardian" class="" <? if($prop['edwardian']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="elizabethan" class="" <? if($prop['elizabethan']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="french" class="" <? if($prop['french']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="gothic" class="" <? if($prop['gothic']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="english" class="" <? if($prop['english']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="liberty" class="" <? if($prop['liberty']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="mediterranean" class="" <? if($prop['mediterranean']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="modern" class="" <? if($prop['modern']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="neoclassic" class="" <? if($prop['neoclassic']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="fine_arts" class="" <? if($prop['fine_arts']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="regency" class="" <? if($prop['regency']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="renaissance" class="" <? if($prop['renaissance']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="roman" class="" <? if($prop['roman']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="spanish" class="" <? if($prop['spanish']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="style_1200" class="" <? if($prop['style_1200']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="style_1300" class="" <? if($prop['style_1300']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="style_1400" class="" <? if($prop['style_1400']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="style_1500" class="" <? if($prop['style_1500']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="style_1600" class="" <? if($prop['style_1600']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="style_1700" class="" <? if($prop['style_1700']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="style_1800" class="" <? if($prop['style_1800']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="style_60_70" class="" <? if($prop['style_60_70']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="style_900" class="" <? if($prop['style_900']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="tudor" class="" <? if($prop['tudor']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="victorian" class="" <? if($prop['victorian']==1) echo "checked"; ?>>
                                     </label>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="running_water" class="" <? if($prop['running_water']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="fireplace_chimney" class="" <? if($prop['fireplace_chimney']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="water_tank" class="" <? if($prop['water_tank']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="solar_collectors" class="" <? if($prop['solar_collectors']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="electricity" class="" <? if($prop['electricity']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="geothermal_energy" class="" <? if($prop['geothermal_energy']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="sanitation" class="" <? if($prop['sanitation']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="source_of_water" class="" <? if($prop['source_of_water']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="gas" class="" <? if($prop['gas']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="gas_gpl" class="" <? if($prop['gas_gpl']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="methane_gas" class="" <? if($prop['methane_gas']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="natural_gas" class="" <? if($prop['natural_gas']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="ups_generator" class="" <? if($prop['ups_generator']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="adsl_line" class="" <? if($prop['adsl_line']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="heat_pump" class="" <? if($prop['heat_pump']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="fireplace_predisposition" class="" <? if($prop['fireplace_predisposition']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="network_computing" class="" <? if($prop['network_computing']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="heating_hot_air" class="" <? if($prop['heating_hot_air']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="heating_none" class="" <? if($prop['heating_none']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="autonomous_heating" class="" <? if($prop['autonomous_heating']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="heating_central_boiler" class="" <? if($prop['heating_central_boiler']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="centralized_warming" class="" <? if($prop['centralized_warming']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="heating_solid_fuel" class="" <? if($prop['heating_solid_fuel']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="electric_heating" class="" <? if($prop['electric_heating']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="heating_gas_gpl" class="" <? if($prop['heating_gas_gpl']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="heating_oil" class="" <? if($prop['heating_oil']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="heating_solar" class="" <? if($prop['heating_solar']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="heating_district_heating" class="" <? if($prop['heating_district_heating']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="satellite" class="" <? if($prop['satellite']==1) echo "checked"; ?>>
                                     </label>
                             ...
                             <label class="col-md-1 col-sm-6 col-xs-12">
                                 <label class="col-md-12  col-sm-12 col-xs-12 mt20 row">
                                     <label class="col-md-6  col-sm-6 col-xs-12">
                                         <input type="checkbox" name="cable_tv" class="" <? if($prop['cable_tv']==1) echo "checked"; ?>>
                                     </label>
                     ...
                     <div class="col-md-9 col-sm-12 col-xs-12 mt5 row">
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12 mt5 row">
                             ...
                             <div class="col-md-12 col-sm-12 col-xs-12">
                                 ...
                                 <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                     <label class="col-md-12  col-sm-12 col-xs-12">
                                         <input type="text" name="actual_mortgage" class="post-add-form-control" placeholder="Inserisci mutuo attuale" value="<? echo $prop['actual_mortgage']; ?>">
                                     </label>
                                 </label>
                                 ...
                                 <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                     <label class="col-md-12  col-sm-12 col-xs-12">
                                         <input type="text" name="balance_difference" class="post-add-form-control" placeholder="Inserisci differenza a saldo" value="<? echo $prop['balance_difference']; ?>">
                                     </label>
                                 </label>
                                 ...
                                 <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                     <label class="col-md-12 col-sm-12 col-xs-12">
                                         <select name="rate_type" class="post-add-selectbox">
                                             <option value="">Seleziona tipo</option>
                                             <option value="fisso" <? if($prop['rate_type']=='fisso') echo "selected"; ?>>Fisso</option>
                                             <option value="misto" <? if($prop['rate_type']=='misto') echo "selected"; ?>>Misto</option>
                                             <option value="variabile" <? if($prop['rate_type']=='variabile') echo "selected"; ?>>Variabile</option>
                                             <option value="variabile-con-opzione" <? if($prop['rate_type']=='variabile-con-opzione') echo "selected"; ?>>Variabile con opzione</option>
                                             <option value="variabile-con-rata-costante" <? if($prop['rate_type']=='variabile-con-rata-costante') echo "selected"; ?>>Variabile con rata costante</option>
                                             <option value="variabile-con-rimborso-flessibile" <? if($prop['rate_type']=='variabile-con-rimborso-flessibile') echo "selected"; ?>>Variabile con rimborso flessibile</option>
                                         </select>
                                     </label>
                                 </label>
                                 ...
                                 <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                     <label class="col-md-12  col-sm-12 col-xs-12">
                                         <input type="text" name="remain_loan" class="post-add-form-control" placeholder="Inserisci residuo mutuo" value="<? echo $prop['remain_loan']; ?>">
                                     </label>
                                 </label>
                                 ...
                                 <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                     <label class="col-md-12  col-sm-12 col-xs-12">
                                         <input type="text" name="remain_years" class="post-add-form-control" placeholder="Inserisci residuo anni" value="<? echo $prop['remain_years']; ?>">
                                     </label>
                                 </label>
                                 ...
                                 <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                     <label class="col-md-12 col-sm-12 col-xs-12">
                                         <select name="periodicity_installment" class="post-add-selectbox">
                                             <option value="">Seleziona tipo</option>
                                             <option value="annuale" <? if($prop['periodicity_installment']=='annuale') echo "selected"; ?>>Annuale</option>
                                             <option value="mensile" <? if($prop['periodicity_installment']=='mensile') echo "selected"; ?>>Mensile</option>
                                             <option value="semestrale" <? if($prop['periodicity_installment']=='semestrale') echo "selected"; ?>>Semestrale</option>
                                             <option value="settimanale" <? if($prop['periodicity_installment']=='settimanale') echo "selected"; ?>>Settimanale</option>
                                         </select>
                                     </label>
                                 </label>
                                 ...
                                 <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                     <label class="col-md-12  col-sm-12 col-xs-12">
                                         <input type="text" name="payment" class="post-add-form-control" placeholder="Inserisci pagamento" value="<? echo $prop['payment']; ?>">
                                     </label>
                                 </label>
                                 ...
                                 <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                     <label class="col-md-12  col-sm-12 col-xs-12">
                                         <input type="text" name="bank" class="post-add-form-control" placeholder="Inserisci banca" value="<? echo $prop['bank']; ?>">
                                     </label>
                                 </label>
                 ...
                 <div class="tab-pane" id="pics"><!--TAB begin-->
                     <div class="col-md-9 col-sm-12 col-xs-12 mt5 row">
                         <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <label class="col-md-4 col-sm-6 col-xs-12 post-add-box-form-font mt20">ID Video immobile</label>
                             <label class="col-md-8  col-sm-6 col-xs-12 mt20">
                                 <label class="col-md-12  col-sm-12 col-xs-12">
                                     <input type="text" name="video" class="post-add-form-control" placeholder="Inserisci url video YouTube" value="https://www.youtube.com/watch?v=<? echo $prop['video']; ?>">
                                 </label>
                             </label>
                                     ...
                                     <div id="carousel" class="carousel slide" data-ride="carousel">
                                         <div class="carousel-inner">
                                             <div class="item active">
                                                 <?php $im=$db->singlerec("select * from listing_images where pid='".$prop['id']."' order by id limit 1"); ?>
                                             ...
                                             if(count($result)>=1) {
                                                 foreach($result as $row) {
                                                     echo '<div class="item"><img src="'.$siteurl.'/images/prop/'.$row['image'].'" class="imge"></div>';
                                                 }
                                             }
                                             ?>
                             ...
                             <div class="col-md-12 col-sm-6 col-xs-12 mt20">
                                 <input type="submit" name="p_ad" value="Modifica immobile!" class="btn-post-add pull-right">
                             </div>
