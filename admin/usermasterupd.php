				 ...
				 <div class="col-sm-6 eq-box-sm">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title"><? echo $TextChange;?> Staff <?echo $Message;?></h3>
						</div>
							...
							<div class="panel-body">
								<table style="padding:25px;">
									<tr>
										...
										<td><input type="text" name="username" class="form-control" id="username" value="<? echo $username; ?>" >
										</td>
									...
									<tr>
										...
										<td><select style="width: 160px;" class="form-control" id="sex" name="sex"><? echo $GenderList; ?></select>
										</td>
									</tr>
									<tr>
										<td>Mobile No <font color="red">*</font></td>
										<td><input type="text" class="form-control" id="mobile_1" name="mobile_1" value="<? echo $mobile_1; ?>" maxlength="10" onkeypress = "return InpOnlyNumbers(event)"></td>
										<td>Phone</td>
									<td><input type="text" name="phone" id="phone" value="<? echo $phone; ?>" class="form-control" maxlength="10" onkeypress = "return InpOnlyNumbers(event)"/></td>
									</tr>
									<tr>
										<td>Email Id <font color="red">*</font></td>
										<td><input type="text" class="form-control" id="email_id" name="email_id" value="<? echo $email_id; ?>"></td>
										<td>Date Of Birth</td>
										<td><input type="text" name="dob" id="dob" value="<? echo $dob; ?>" class="form-control" Placeholder="Select Date Of Birth"></td>
									</tr>
								<!--	<tr>
										<td>Bank Name </td>
										<td><input type="text" class="form-control" id="bank_name" name="bank_name" value="<? echo $bank_name; ?>"></td>
										<td>Account No </td>
										<td><input type="text" class="form-control" id="acc_no" name="acc_no" value="<? echo $acc_no; ?>" ></td>
									</tr>
									<tr>
										<td>Ifsc Code </td>
										<td><input type="text" class="form-control" id="ifsc_code" name="ifsc_code" value="<? echo $ifsc_code; ?>"></td>
										<td>Branch Name </td>
										<td><input type="text" class="form-control" id="branch_name" name="branch_name" value="<? echo $branch_name; ?>" ></td>
									</tr>-->
									<!--<tr>
										<td>Department<font color="red">*</font></td>
										<td><select class="form-control" name="dept_id"><? echo $DeptList; ?></select></td><td></td><td><input type="text" name="doj" id="doj" value="<? echo $doj; ?>"  placeholder="Date Of Joining"/></td>
									</tr>-->
									<tr>
										<!-- <td>Qualification <font color="red">*</font></td>
										<td><input type="text" class="form-control" id="qualification" name="qualification" value="<? echo $qualification; ?>" ></td> -->
										<td>Image</td>
										<td><span <?echo $imghid;?>><img src="uploads/userimages/<? echo $userimages; ?>" width="120px" height="120px"><br><? echo $DisplayDeleteImgLink; ?></span>
										<input name="UsrImage" type="file"></td>
									</tr>
									<!-- <tr>
										<td valign="top">Address <font color="red">*</font></td>
										<td><textarea name="address_1" id="address_1" class="form-control" cols="40" rows="4"><? echo $address_1; ?></textarea></td>
										<td valign="top">Description </td>
										<td><textarea name="description" id="description" class="form-control" cols="40" rows="4"><? echo $description; ?></textarea></td>
									</tr> -->
									
									<tr>
										<!--<td valign="top">Refered By <font color="red">*</font></td>
										<td><select style="width:344px;" id="referedby" name="referedby" class="form-control"><? echo $RefList; ?></select></td>
									<td>Salary</td><td><input type="text" id="salary" name="salary" value="<? echo $salary; ?>" maxlength="10" onkeypress = "return InpOnlyNumbers(event)"></td>-->
