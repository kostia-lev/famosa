...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
	 ...
	 * document creator
	 */
	define ('PDF_CREATOR', 'Sulabh');

	/**
	 * document author
	 */
	define ('PDF_AUTHOR', 'Sulabh');
	 ...
	 */
	define ('PDF_HEADER_STRING', "Balamurugan ");

	/**
	 * image logo
	 */
	//define ('PDF_HEADER_LOGO', 'jenlogo.gif');
        define ('PDF_HEADER_LOGO', 'sulabh.gif');
